...
3. **Update the registers:** `brief/build/INDEX.md` (register any new build/addendum numbers — CHECK the index before minting a number; 70H got double-allocated by skipping this), `brief/CURRENT.md`, and `brief/build/DEBT.md` deltas.
