...
**UNENFORCEABLE** — same net-new-value-creation classification judgement as above; not derivable from a table/route name alone. No static check can decide whether a NEW feature is "reading existing data" or "creating new business" — that is a product-semantics call.
