...
export function StepCompanyReview({ company, signOffEmail, applicationId, token, emailVerified, onVerified, consent, setConsent, imDirector, companyRole }: Readonly<{
