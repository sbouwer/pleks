...
export interface CoApplicant { firstName: string; lastName: string; email: string; phone: string; idType?: string; idNumber: string; role: CoRole; invited: boolean; designation?: string }
