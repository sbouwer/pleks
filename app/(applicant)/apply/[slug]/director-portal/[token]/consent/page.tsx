 ...
 * Data:   application_co_applicants — updates stage2_consent_given_at
 * Notes:  D-14B-01: each director must consent individually. This page is the explicit-consent
 *         capture for the director as a separate data subject under POPIA s11(1)(a).
 */
...
export default async function DirectorConsentPage({
  ...
  const { data: coApp, error } = await service
    ...
    .select("id, first_name, primary_application_id, stage2_consent_given_at, access_token_expires, declined_at")
