/**
 * app/(dashboard)/billing/invoices/[invoiceId]/page.tsx — Supplier invoice detail view
 *
 * Route:  /billing/invoices/[invoiceId]
 * Auth:   gatewaySSR()
 * Data:   reads supplier_invoices (joined contractor_view, properties, maintenance_requests), org-scoped
 */
