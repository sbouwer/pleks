...
export function DashboardAlertsBell({
  surrendered, showDepositSetup, tier, leaseCount,
}: Readonly<{ surrendered: SurrenderedCommRow[]; showDepositSetup: boolean; tier: Tier; leaseCount: number }>) {
  ...
  const count = (showDepositSetup ? 1 : 0) + (nearLimit ? 1 : 0) + groupKeys.size
