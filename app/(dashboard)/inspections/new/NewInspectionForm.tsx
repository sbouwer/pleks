...
/**
 * app/(dashboard)/inspections/new/NewInspectionForm.tsx — New inspection form with property/unit/tenant selection
 *
 * Route:  /inspections/new
 * Auth:   gateway (dashboard layout)
 * Data:   properties, units, leases, tenant_view via Supabase client; createInspection server action
 */
