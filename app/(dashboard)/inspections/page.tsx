/**
 * app/(dashboard)/inspections/page.tsx — Inspections list page (server prefetch + hydration)
 *
 * Route:  /inspections
 * Auth:   getServerOrgMembership (redirects to /login if no org membership)
 * Data:   prefetches fetchInspections(supabase, orgId) into React Query, then hydrates InspectionsPageClient
 */
