...
/**
 * app/(dashboard)/leases/[leaseId]/OverviewTab.tsx — Overview tab for a lease: KPIs, contacts, collection chart
 *
 * Route:  /leases/[leaseId] (Overview tab)
        ...
        <div className="rounded-xl border bg-card p-4">
          ...
          {landlord ? (
            ...
            <p className="text-sm text-muted-foreground">
              No owner linked.{" "}
              {propertyId && (
                <InlineLink href={`/properties/${propertyId}`}>Link here</InlineLink>
              )}
            </p>
          )}
        </div>
