/**
 * app/(dashboard)/properties/classify/page.tsx — Lists imported properties still needing their type confirmed
 *
 * Route:  /properties/classify
 * Auth:   getServerOrgMembership() gate; data via service client
 * Data:   reads properties where scenario_type is null (org-scoped)
 */
