...
/**
 * app/(dashboard)/properties/new/steps/StepScenarioFollowUp.tsx — New-property wizard step: scenario-specific follow-up questions
 *
 * Notes:  questions derive from the selected scenario definition (lib/properties/scenarios); answers shape lease clauses + inspection profile
 */
