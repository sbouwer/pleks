...
/**
 * app/(dashboard)/reports/tabs/ContractorPerformanceTab.tsx — contractor performance report: jobs, completion rate, no-shows and spend per contractor
 *
 * Data:   GET /api/reports?type=contractor_performance (via useReportData); CSV/PDF export via /api/reports/export
 */
