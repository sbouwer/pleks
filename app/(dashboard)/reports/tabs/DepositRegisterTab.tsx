...
/**
 * app/(dashboard)/reports/tabs/DepositRegisterTab.tsx — deposit register: deposits held with interest, return deadlines and status
 *
 * Data:   GET /api/reports?type=deposit_register (via useReportData); CSV/PDF export via /api/reports/export
 */
