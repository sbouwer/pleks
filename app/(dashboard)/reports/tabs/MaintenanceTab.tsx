...
/**
 * app/(dashboard)/reports/tabs/MaintenanceTab.tsx — maintenance costs report: spend by category and property + SLA performance
 *
 * Data:   GET /api/reports?type=maintenance_costs (via useReportData); CSV export via /api/reports/export
 */
