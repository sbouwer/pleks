...
/**
 * app/(dashboard)/reports/tabs/OccupancyTab.tsx — occupancy report: per-property occupancy rates + vacancy duration table
 *
 * Data:   GET /api/reports?type=occupancy (via useReportData); CSV export via /api/reports/export
 */
