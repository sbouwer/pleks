...
/**
 * app/(dashboard)/reports/tabs/OwnerPortfolioTab.tsx — owner portfolio summary: income/expenses/net per owner and property
 *
 * Data:   GET /api/reports?type=owner_portfolio (via useReportData); CSV export via /api/reports/export
 */
