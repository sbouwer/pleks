...
/**
 * app/(dashboard)/reports/tabs/PopiaConsentAuditTab.tsx — POPIA consent audit: consent records by type with grant timestamps
 *
 * Data:   GET /api/reports?type=popia_consent_audit (via useReportData); CSV/PDF export via /api/reports/export
 */
