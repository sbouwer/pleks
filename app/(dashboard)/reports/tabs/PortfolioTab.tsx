...
/**
 * app/(dashboard)/reports/tabs/PortfolioTab.tsx — portfolio performance summary: occupancy, income, arrears, maintenance and expiry metrics
 *
 * Data:   GET /api/reports?type=portfolio_summary (via useReportData)
 * Notes:  Also reused as the placeholder view for annual_tax_summary (not yet built).
 */
