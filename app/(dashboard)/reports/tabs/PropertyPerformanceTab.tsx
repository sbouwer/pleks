...
/**
 * app/(dashboard)/reports/tabs/PropertyPerformanceTab.tsx — property performance report: gross/expenses/net income per property
 *
 * Data:   GET /api/reports?type=property_performance (via useReportData); CSV/PDF export via /api/reports/export
 */
