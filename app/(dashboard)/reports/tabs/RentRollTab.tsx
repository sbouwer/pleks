...
/**
 * app/(dashboard)/reports/tabs/RentRollTab.tsx — rent roll: per-unit rent, lease dates, payment method, status and arrears
 *
 * Data:   GET /api/reports?type=rent_roll (via useReportData); CSV/PDF export via /api/reports/export
 */
