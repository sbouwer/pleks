...
/**
 * app/(dashboard)/reports/tabs/TenantDirectoryTab.tsx — tenant directory: active tenants + co-tenants with contact and lease details
 *
 * Data:   GET /api/reports?type=tenant_directory (via useReportData); CSV/PDF export via /api/reports/export
 */
