...
/**
 * app/(dashboard)/reports/tabs/TenantPaymentHistoryTab.tsx — tenant payment history: invoiced/paid/balance totals per tenant
 *
 * Data:   GET /api/reports?type=tenant_payment_history (via useReportData); CSV/PDF export via /api/reports/export
 */
