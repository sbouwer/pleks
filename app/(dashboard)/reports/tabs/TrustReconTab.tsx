...
/**
 * app/(dashboard)/reports/tabs/TrustReconTab.tsx — trust reconciliation: opening/closing balance with credit/debit ledger lines
 *
 * Data:   GET /api/reports?type=trust_reconciliation (via useReportData); CSV/PDF export via /api/reports/export
 */
