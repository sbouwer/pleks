...
/**
 * app/(dashboard)/reports/tabs/VacancyAnalysisTab.tsx — vacancy analysis: vacant units, days vacant and estimated lost income
 *
 * Data:   GET /api/reports?type=vacancy_analysis (via useReportData); CSV/PDF export via /api/reports/export
 */
