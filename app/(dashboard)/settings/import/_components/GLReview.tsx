...
/**
 * app/(dashboard)/settings/import/_components/GLReview.tsx — Review matched GL transactions and execute the import
 *
 * Route:  /settings/import (step within GL import wizard)
 * Auth:   gateway (dashboard layout)
 * Data:   GL blocks + lease/property match maps passed as props; POSTs to /api/import/gl-execute
 */
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex gap-3">
        ...
        <ActionButton tone="primary" icon={loading ? <Loader2 className="size-4 animate-spin" /> : undefined} onClick={handleImport} className="flex-1" disabled={loading}>
          {loading ? "Importing..." : "Import GL history"}
        </ActionButton>
      </div>
    </div>
  )
