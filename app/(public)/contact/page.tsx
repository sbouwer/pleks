        ...
        <div className="pub-contact-grid">
          ...
          <aside className="pub-contact-personal">
            ...
            <div className="pub-contact-channels">
              ...
              <div className="pub-contact-channel">
                <span className="pub-contact-channel-label">
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" style={{ verticalAlign: "-2px", marginRight: 6 }} aria-hidden="true">
                ...
                <a
                  ...
                  className="pub-contact-channel-value"
                >
                  {PHONE_DISPLAY}
                </a>
              </div>
