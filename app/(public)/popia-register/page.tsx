      ...
      <section id="part-b">
        ...
        <div className="purpose-entry">
          ...
          <div className="purpose-meta">
            ...
            <div className="pm-row"><span className="pm-k">Retention</span><span className="pm-v">Follows Purpose B4 — declined applicants: 90 days from pull date · approved applicants: 5 years post-lease-termination</span></div>
        ...
        <div className="purpose-entry">
          ...
          <div className="purpose-meta">
            ...
            <div className="pm-row"><span className="pm-k">DPIA</span><span className="pm-v">Completed — conducted in accordance with POPIA s17 accountability obligations and Information Regulator Guidance Note 4 (2024). Available on request to the Information Officer via the data-subject request pathway.</span></div>
          </div>
        </div>
