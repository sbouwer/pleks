...
/**
 * app/(public)/property-info/[token]/ChecklistInfoForm.tsx — owner insurance-checklist response form (yes/no/not-sure)
 *
 * Notes:  Client sub-component of the token-gated /property-info/[token] page. Submits via the
 *         submitOwnerChecklistResponse server action; requires POPIA consent before submit.
 */
