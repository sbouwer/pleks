...
/**
 * app/(public)/property-info/[token]/PropertyInfoForm.tsx — owner property-info collection form (topic-driven fields)
 *
 * Notes:  Client sub-component of the token-gated /property-info/[token] page. Renders the field
 *         set for the request topic and submits via the submitPropertyInfo server action;
 *         requires POPIA consent before submit.
 */
