/**
 * app/(public)/svgs/PegboardSVG.tsx — decorative key-board pegboard line-art background for public pages
 *
 * Notes:  Presentational, aria-hidden. Full-bleed amber-ink watermark; embeds the current year in its header text.
 */
