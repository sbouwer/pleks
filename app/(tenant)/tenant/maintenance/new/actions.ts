...
/**
 * app/(tenant)/tenant/maintenance/new/actions.ts — tenant portal: submit a new maintenance request
 *
 * Route:  /tenant/maintenance/new (server action)
 * Auth:   getTenantSession() — portal session supplies tenantId/leaseId/orgId/unitId (never caller-supplied).
 * Data:   maintenance_requests (+ unit/property routing) via the service client; photos in storage.
 */
