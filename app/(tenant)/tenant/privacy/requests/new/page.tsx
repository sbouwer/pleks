/**
 * app/(tenant)/tenant/privacy/requests/new/page.tsx — New data-subject request form
 *
 * Route:  /tenant/privacy/requests/new?org=<org_id>
 * Auth:   Tenant portal session
 * Data:   POST /api/popia/request
 * Notes:  Shows RequestTypePicker; nuke type shows NukeCarveoutDisclosure first (D-POPIA-05).
 */
"use client"
