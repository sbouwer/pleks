...
export async function GET(
  ...
  const payDate = fmtDateLongZA(payment.payment_date)
...
<div class="page">
  ...
  <div class="footer">
    <span class="footer-note">Generated by Pleks · ${new Date().toLocaleDateString("en-ZA", { timeZone: SA_TIMEZONE, day: "numeric", month: "short", year: "numeric" })}</span>
