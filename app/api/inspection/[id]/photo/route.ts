/**
 * app/api/inspection/[id]/photo/route.ts — upload an inspection photo
 *
 * Route:  POST /api/inspection/[id]/photo
 * Auth:   auth.getUser() + user_orgs membership lookup (service client)
 * Data:   uploads to 'inspection-photos' storage; inserts inspection_photos
