/**
 * app/api/trust/audit-export/[exportId]/xlsx/route.ts — Serve trust audit export XLSX
 *
 * Route:  /api/trust/audit-export/[exportId]/xlsx
...
export async function GET(
  ...
  const filename = `trust-audit-${exportRow.period_id.slice(0, 8)}.xlsx`
