...
The current work front. Property insurance/broker/managing-scheme architecture (BUILD_59) is fully shipped. The scenario-driven smart property setup wizard (BUILD_60) is at Phases 1–17 + 19 + 21 + 22 of 22 done — the wizard saves real properties end-to-end, the completeness widget drives ongoing setup, admins can reclassify or bulk-classify imported properties, the tier gate now lives at lease activation, and the Overview tab surfaces the scenario label + operating hours. Phase 20 (email templates) and Phase 18 (mobile responsive audit) remain. BUILD_61 is a mechanical route-alignment refactor spec'd but not yet started.
