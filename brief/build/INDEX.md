...
The current work front. Property insurance/broker/managing-scheme architecture (BUILD_59) is fully shipped. The scenario-driven smart property setup wizard (BUILD_60) is at Phases 1–17 of 22 done — the wizard saves real properties end-to-end, the completeness widget drives ongoing setup, and admins can reclassify or bulk-classify imported properties. BUILD_61 is a mechanical route-alignment refactor spec'd but not yet started.
