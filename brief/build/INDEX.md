...
The current work front. Property insurance/broker/managing-scheme architecture (BUILD_59) is fully shipped. The scenario-driven smart property setup wizard (BUILD_60) is in progress — Phases 1–2 of 22 done. BUILD_61 is a mechanical route-alignment refactor spec'd but not yet started.
