...
The current work front. Property insurance/broker/managing-scheme architecture (BUILD_59) is fully shipped. The scenario-driven smart property setup wizard (BUILD_60) is at Phases 1–13 of 22 done — the wizard now saves real properties end-to-end. BUILD_61 is a mechanical route-alignment refactor spec'd but not yet started.
