# FINAL DRAFT (v3): Optional Lease Clauses — Ready for Sign-Off

**Status:** FINAL DRAFT — all preliminary and targeted legal review feedback incorporated. Requires attorney final sign-off before seeding into production.

**Review history:**
- v1: Initial AI draft (Sonnet 4.6)
- v2: Incorporated preliminary legal review (CPA indemnity carve-outs, pet deposit restructure, borehole Schedule 1, solar municipal approval, no-reduction softening)
- v3 (this): Incorporated targeted improvements (reasonableness qualifiers, "solely" limiters, off-grid future-proofing, latent defects coverage, routine maintenance clarity, Annexure D safety valve)

**All changes tracked with `[v3]` markers in body text below.**
...
**Description:** Governs the keeping of domestic animals, pet deposit allocation, damage liability, and removal conditions.
...
**v3 changes:**
- Sub-clause 6: "any and all claims" → "any reasonable claims" — aligns with CPA fairness standard, prevents "overbroad/unlimited" argument
- Sub-clause 7: added "acting reasonably" to consent withdrawal — consistent reasonableness standard
- Sub-clause 8: added "in itself" and "unless otherwise required by law" — consistency with utilities clause pattern
...
**Description:** Governs allocated parking, access rights, vehicle restrictions, and parking bay conditions.
...
**v3 changes:**
- Sub-clause 5: added "reasonably" to "required to be kept clear"
- Sub-clause 6: "any claims" → "any reasonable claims" — consistent CPA alignment
- Sub-clause 8: added "excluding fair wear and tear and latent defects" and "reasonably required" — prevents disputes where garage door motor fails naturally or has a manufacturing defect
...
**Description:** Governs solar, borehole, and other alternative utility installations including Schedule 1 domestic use.
...
**v3 changes:**
- Sub-clause 1: municipal supply requirement now reads "Unless the property is designed or approved for off-grid use, or otherwise agreed in writing" — future-proofs for solar-first and off-grid properties
- Sub-clause 4 (after maintenance list): added explicit clarification: "routine maintenance shall not include technical servicing, electrical repairs, component replacement, or any work reasonably requiring a qualified electrician, plumber or specialist technician" — prevents tenants being pushed into expensive technical repairs and eliminates ambiguity about inverter faults, battery degradation, etc.
...
**Description:** Governs fibre, satellite, and telecommunications infrastructure with provider access provisions.
...
**v3 changes:**
- Sub-clause 3: "no claim… howsoever caused" → "no claim arising solely from any interruption, degradation or failure" — the word "solely" is key: protects landlord from service outage claims while not blocking legitimate claims tied to landlord conduct

---

## 5. Annexure D hierarchy rule (amended)

Append to existing `general` clause in `lease_clause_library`:
...
**v3 change:** Added "provided that such provisions are lawful and not inconsistent with applicable legislation" — prevents badly filled-in Annexure D terms from overriding lawful main body clauses. Safety valve for auto-generated leases where agents may enter contradictory or unlawful special terms.

---

## 6. Seed migration (final)

Once signed off, create `supabase/migrations/011_optional_clauses_seed.sql`:

```sql
-- 011_optional_clauses_seed.sql
-- Four optional clauses for unit feature auto-mapping.
-- Legal review: v1 [date], v2 [date], v3 final [date]
-- Reviewed by: [attorney name / firm]
...
-- Annexure D hierarchy rule — append to existing general clause
...
|---------|------|-------------|--------|
| v1 | [date] | AI draft (Sonnet 4.6) | Superseded |
| v2 | [date] | [Preliminary legal review] | Superseded |
| v3 | [date] | [Targeted legal review] | Pending final sign-off |
| Final | [date] | [Attorney name / firm] | **[ ] APPROVED** |

**Attorney sign-off:**

I, _________________________, confirm that I have reviewed the above four lease clauses (pets, parking, alternative utilities, telecommunications) and the Annexure D hierarchy amendment, and confirm that they comply with the Rental Housing Act 50 of 1999, the Consumer Protection Act 68 of 2008, and all applicable South African legislation. I approve them for use in the Pleks lease generation system.
