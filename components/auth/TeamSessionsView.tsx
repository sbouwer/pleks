...
/**
 * components/auth/TeamSessionsView.tsx — org-wide list of each team member's most recent sign-in activity
 *
 * Data:   Client-fetches user_orgs + latest auth_events per member via the browser Supabase client (RLS-scoped to the org).
 */
