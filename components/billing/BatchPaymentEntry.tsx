...
/**
 * components/billing/BatchPaymentEntry.tsx — Batch rent-payment entry table
 *
 * Route:  /billing (embedded)
 * Auth:   Dashboard layout (gateway-protected)
 * Data:   GET /api/rent-invoices?status=open · POST /api/rent-invoices to record
 */
