...
/**
 * components/contacts/edit/TenantEmploymentForm.tsx — client form to edit a tenant's employment and preferred-contact details
 *
 * Data:   PATCH /api/tenants, then router.refresh().
 */
