...
/**
 * components/gates/UpgradeCTA.tsx — locked-feature upgrade prompt card shown when a tier gate fails
 *
 * Notes:  featureLabels maps feature keys to display names; falls back to the humanised key.
 */
