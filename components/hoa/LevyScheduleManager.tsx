...
/**
 * components/hoa/LevyScheduleManager.tsx — manages a scheme's levy schedules and previews per-unit levy allocations from a budget
 *
 * Data:   Persists levy schedules via the HOA API; per-unit amounts are computed server-side and returned as CalcResult.
 * Notes:  Calculation method (PQ / m² / fixed) drives how the total budget is split across units.
 */
