...
/**
 * components/hoa/ReserveFundManager.tsx — ledger of a scheme's reserve-fund movements with a running balance
 *
 * Data:   Seeded from initialEntries/initialBalance for the given hoaId; new entries persist via the HOA API.
 * Notes:  Entry direction (in/out) adjusts the tracked balance; amounts held in cents.
 */
