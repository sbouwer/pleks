...
/**
 * components/layout/KeyboardShortcuts.tsx — global "G + key" navigation shortcuts plus a "?" help overlay
 *
 * Notes:  Ignores keystrokes while an input/textarea/select or contenteditable is focused; G-mode times out after 1.5s.
 */
