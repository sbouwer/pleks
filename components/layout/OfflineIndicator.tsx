...
/**
 * components/layout/OfflineIndicator.tsx — mobile top banner signalling offline state or in-progress photo sync
 *
 * Notes:  Tracks connectivity via the offline syncManager and SYNC_PROGRESS messages from the service worker; mobile-only.
 */
