...
/**
 * components/leases/BrandingPreview.tsx — miniature two-page preview of how the org's branding renders on a lease document
 *
 * Notes:  Presentational. Accent colour is validated against a #RRGGBB pattern before use, falling back to grey.
 */
const CLAUSE_1 =
