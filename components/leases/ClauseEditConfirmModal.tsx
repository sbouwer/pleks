...
/**
 * components/leases/ClauseEditConfirmModal.tsx — attestation dialog gating clause edits behind a legal-responsibility acknowledgement
 *
 * Data:   POST /api/leases/confirm-clause-edit records the org's confirmation before custom edits are allowed.
 */
