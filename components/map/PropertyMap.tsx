/**
 * components/map/PropertyMap.tsx — embedded Google Maps iframe for a property address
 *
 * Notes:  Builds an embed query from street/city/province + "South Africa"; uses the public maps embed URL (no API key).
 */
