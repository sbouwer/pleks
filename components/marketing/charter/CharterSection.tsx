...
const COMMITMENTS: Commitment[] = [
  ...
  },
  {
    ...
    body: "FitScore uses that applicant's own four declared inputs. Outcomes aren't pooled across agencies.",
    foot: "Zero cross-org aggregation",
    hover: "Why this matters",
    href: "/for-agents/sovereign-data",
