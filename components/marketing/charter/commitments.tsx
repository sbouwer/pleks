...
export const CHARTER_COMMITMENTS: readonly CharterCommitment[] = [
  {
    ...
    body: "Client funds stay in your Section 54 trust account, at your own bank, under your own FFC. Pleks has no outbound payment rail — and can't grow one without a total architectural rewrite. We didn't just write a policy; we removed the pipes.",
