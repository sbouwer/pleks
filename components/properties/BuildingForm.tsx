...
/**
 * components/properties/BuildingForm.tsx — create/edit form for a building, including type, heritage grading and maintenance rhythm
 *
 * Data:   createBuilding / updateBuilding server actions.
 */
