/**
 * components/properties/PropertyBuildingsSection.tsx — lists a property's buildings with unit/occupancy counts and insurance-renewal flags
 *
 * Notes:  Presentational. Links out to add/edit building; buildings arrive pre-fetched via props.
 */
