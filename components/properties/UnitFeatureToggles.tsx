...
/**
 * components/properties/UnitFeatureToggles.tsx — toggles a unit's feature flags and surfaces which lease clauses each feature auto-adds
 *
 * Data:   updateUnitFeatures server action; feature→clause mapping from getAutoClausesForFeatures.
 */
