...
/**
 * components/reports/WelcomePackBanner.tsx — dismissible banner to generate a landlord welcome-pack report
 *
 * Data:   opens /api/reports/welcome-pack (orgId + landlordId) in a new tab
 * Notes:  dismissal persisted per-landlord in localStorage
 */
