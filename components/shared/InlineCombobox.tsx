...
/**
 * components/shared/InlineCombobox.tsx — generic searchable combobox whose trigger becomes a live filter input on click
 *
 * Notes:  Client-side filtering over the supplied items via getSearchText; closes on outside mousedown or Escape.
 */
