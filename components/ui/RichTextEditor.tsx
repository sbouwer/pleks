...
/**
 * components/ui/RichTextEditor.tsx — TipTap rich-text editor with a formatting toolbar (bold/italic/underline, headings, lists)
 *
 * Notes:  Exposes an insertText(text) imperative handle via ref for template-variable insertion; syncs external value changes into the editor.
 */
