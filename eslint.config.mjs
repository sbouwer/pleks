...
const eslintConfig = defineConfig([
  ...
  ]),
  {
    ...
    files: ["**/*.ts", "**/*.tsx"],
    plugins: { pleks: { rules: { "require-supabase-error-check": requireSupabaseErrorCheck, "no-popia-raw-delete": noPopiaRawDelete, "require-audit-on-sensitive-mutation": requireAuditOnSensitiveMutation, "require-scope-on-delete": requireScopeOnDelete, "settings-use-detail-tabs": settingsUseDetailTabs, "no-cookie-client-from": noCookieClientFrom, "require-org-scope-on-service-write": requireOrgScopeOnServiceWrite, "require-id-number-encryption": requireIdNumberEncryption, "no-direct-resend-send": noDirectResendSend, "no-raw-cron-secret": noRawCronSecret, "no-adhoc-dates": noAdhocDates, "no-raw-process-env": noRawProcessEnv, "no-raw-content-hash": noRawContentHash, "no-rerolled-phone-normalise": noRerolledPhoneNormalise, "no-rerolled-money-format": noRerolledMoneyFormat, "no-inline-app-url": noInlineAppUrl, "no-raw-audit-log-insert": noRawAuditLogInsert, "no-rerolled-property-label": noRerolledPropertyLabel } } },
    rules: { "pleks/require-supabase-error-check": "error", "pleks/no-popia-raw-delete": "error", "pleks/require-audit-on-sensitive-mutation": "error", "pleks/require-scope-on-delete": "error", "pleks/settings-use-detail-tabs": "error", "pleks/no-cookie-client-from": "error", "pleks/require-org-scope-on-service-write": "error", "pleks/require-id-number-encryption": "error", "pleks/no-direct-resend-send": "error", "pleks/no-raw-cron-secret": "error", "pleks/no-adhoc-dates": "error", "pleks/no-raw-process-env": "error", "pleks/no-raw-content-hash": "error", "pleks/no-rerolled-phone-normalise": "error", "pleks/no-rerolled-money-format": "error", "pleks/no-inline-app-url": "error", "pleks/no-raw-audit-log-insert": "error", "pleks/no-rerolled-property-label": "error" },
  },
  {
    rules: {
