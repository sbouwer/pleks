...
export const TEMPLATE_REGISTRY: Record<string, TemplateEntry> = {
  ...
  "application.verify_code": {
    key: "application.verify_code", channel: "email", category: "applications", is_mandatory: true,
    description: "Applicant email verification code (anti-bot, before submit)",
  },
  "application.listing_updated": {
    key: "application.listing_updated", channel: "email", category: "applications", is_mandatory: false,
    description: "Applicant notified the listing they applied for was changed",
  },
