...
SELECT 'system', 'email', 'Application Update — Stage 2 Decline', 'Neutral post-screening decline. NEUTRAL-DECLINE doctrine: no reason in subject or body (F1 — {{reason}} dropped; higher NCA/POPIA stakes post-screening).', 'applications', 'correspondence', 'application.declined_stage2',
  'Application update — {{unitLabel}}, {{propertyName}}', ARRAY['{{recipient.salutation}}', '{{unitLabel}}', '{{propertyName}}', '{{branding.orgName}}'], 1, 'ADDENDUM_70G / R7.3 (live: emails.tsx) — F1 reason dropped · Standard Applicant Footer (POPIA/IR)', false,
  '[{"type":"salutation","text":"{{recipient.salutation}}"},{"type":"paragraph","text":"Thank you for your application for **{{unitLabel}}** at {{propertyName}}."},{"type":"paragraph","text":"After completing the full screening evaluation, we have decided not to proceed with your application. If you have any questions, please contact {{branding.orgName}}."},{"type":"paragraph","text":"The screening fee of R 250 is non-refundable as communicated at the time of payment."},{"type":"paragraph","text":"We wish you well in finding your next home."},{"type":"paragraph","text":"Your personal information is processed for the purpose of assessing your rental application, including tenant risk and affordability. You may request access to, correction of, or deletion of your personal information where applicable under the Protection of Personal Information Act 4 of 2013. Should you believe your personal information has been processed unlawfully, you may lodge a complaint with the Information Regulator (South Africa) — current contact details are published at www.inforegulator.org.za."}]'::jsonb, NULL
WHERE NOT EXISTS (
