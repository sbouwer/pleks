...
export const STATUTORY_SEEDS: TemplateSeed[] = [
  ...
  // ── Deposit return schedule — RHA s5(3)(g)+s5(7); 14 days of restoration (O-15) ─────────────
  {
    ...
    legalReviewRef: "ADDENDUM_70C §3.3 (F-1 #5/#6 · O-15 · FINDING R2/R3/R4)",
    issuedUnder: "This notice is issued pursuant to Section 5(7) of the Rental Housing Act 50 of 1999. Reference: {{referenceNumber}}. Landlord agent: {{branding.orgName}}. If you believe this schedule is incorrect, you may also refer the matter to the Rental Housing Tribunal in your province.",
    body: [
      { type: "salutation", text: "{{recipient.salutation}}" },
  ...
  // ── Move-in inspection report — RHA s5(3)(c); absolute disagree deadline ────────────────────
  {
    ...
    legalReviewRef: "ADDENDUM_70C §4.4 (F-1 Tier-3 s5(3)(c) · FINDING R2/R4)",
    issuedUnder: "This report documents the joint inspection conducted pursuant to section 5(3)(c) of the Rental Housing Act 50 of 1999. Reference: {{referenceNumber}}. Landlord agent: {{branding.orgName}}. This document is maintained as Tribunal evidence. If you believe the report is inaccurate, you may refer the matter to the Rental Housing Tribunal in your province.",
    body: [
      { type: "salutation", text: "{{recipient.salutation}}" },
      ...
      { type: "callout", tone: "info", text: "Your right to disagree: if you disagree with any aspect of this report, you must notify us in writing by no later than **{{disagreeDeadline}}** read with the applicable clause of your Lease Agreement. Please reply to this email with your specific objections and supporting evidence (photographs, prior correspondence). Objections received after this date may not be considered." },
      { type: "legalFooterSlot" },
    ],
  },
