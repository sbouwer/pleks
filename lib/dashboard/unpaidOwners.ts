/**
 * lib/dashboard/unpaidOwners.ts — list owner statements with outstanding owner payouts for the dashboard
 *
 * Data:   reads owner_statements (pending/on_hold/partial) joined to properties, then landlord_view for owner names, org-scoped.
 */
