/**
 * lib/import/detectUnitConflicts.ts — group import rows mapping to the same unit and classify the conflict (duplicate / previous / co-tenant)
 *
 * Notes:  classification uses name similarity and lease-start spread — >90 days apart reads as a previous tenant, same start with different names as co-tenants.
 */
