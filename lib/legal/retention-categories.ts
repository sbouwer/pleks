...
export const RETENTION_CATEGORIES: readonly RetentionCategory[] = [
  ...
  {
    category: "Rental applications — declined or withdrawn",
    subLabel: "automatic purge — all associated records including identity documents, bank statements, income records",
    retention: "90 days from rejection",
    retentionYearsMin: 90 / 365,
    basis: "POPIA s14 — no longer than necessary. Retention extended only for active legal hold, ongoing dispute, fraud investigation, or compliance purposes.",
  },
  {
    category: "Credit check results",
    subLabel: "declined / withdrawn applications",
    retention: "90 days (purged with application package)",
    retentionYearsMin: 90 / 365,
    basis: "POPIA s14 · Credit Bureau Code of Conduct",
  },
  {
    category: "Credit check results",
