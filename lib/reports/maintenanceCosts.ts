/**
 * lib/reports/maintenanceCosts.ts — builds the Maintenance Costs report (completed-job spend broken down by category and property, plus per-urgency SLA-met counts)
 *
 * Data:   reads `maintenance_requests` (+ joined contractor_view/units/properties) and `units` counts for the org/period; returns MaintenanceCostData
 */
