/**
 * lib/reports/maintenanceSla.ts — builds the Maintenance SLA report (resolution time vs target per urgency, compliance rates, and breach list)
 *
 * Data:   reads `maintenance_requests` (+ joined properties) for the org/period; returns MaintenanceSlaData
 * Notes:  SLA targets — emergency 4h, urgent 24h, routine 72h
 */
