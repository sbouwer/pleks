/**
 * lib/reports/occupancy.ts — builds the Occupancy report (per-property occupied/vacant/notice counts, occupancy rates, and per-unit vacancy durations)
 *
 * Data:   reads `properties`, `units`, and `unit_status_history` (to derive vacant-since) for the org; returns OccupancyData
 */
