/**
 * lib/reports/popiaConsentAudit.ts — builds the POPIA Consent Audit report (consent_log records grouped by consent type, with subject names resolved)
 *
 * Data:   reads `consent_log` and resolves subject emails → names via `contacts` for the org; returns PopiaConsentAuditData
 */
