/**
 * lib/reports/reportBranding.ts — fetch org branding for PDF report generation
 *
 * Data:   organisations, storage (signed logo URL) via service client
 * Notes:  Used by PDF generators (owner statement, LOD, comm export).
 *         Resolves signed logo URL from org-assets bucket; falls back to logo_url.
 *         Operating hours are loaded separately to isolate schema-optional columns.
 */
