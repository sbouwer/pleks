/**
 * lib/reports/tenantPaymentHistory.ts — builds the Tenant Payment History report (invoiced vs paid, balance, last-payment date, and payment count per tenant)
 *
 * Data:   reads `leases`, `rent_invoices`, `payments`, and `tenant_view` for the org/period; returns TenantPaymentHistoryData
 */
