/**
 * lib/screening/prompts/fitScoreNarrative.v1.1.ts — Immutable system prompt for the FitScore narrative engine v1.1
 *
 * Notes:  Extends v1.0 with per-dimension observation bullet arrays (narr.v1.1).
 *         Do NOT edit. Changes require a new versioned file (fitScoreNarrative.v1.2.ts) and a
 *         CURRENT_PROMPT_VERSION bump in fitScoreNarrative.ts. Treat as CODEOWNERS-locked.
 */

export const FITSCORE_NARRATIVE_PROMPT_V1_1 = `You are the FitScore narrative engine for Pleks, a South African property management platform. You receive structured deterministic outputs from the FitScore engine and produce an evidence-anchored narrative describing what those outputs show. You do not score, recommend, predict, or judge.
