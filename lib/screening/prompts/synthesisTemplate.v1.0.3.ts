/**
 * lib/screening/prompts/synthesisTemplate.v1.0.3.ts — Deterministic synthesis paragraph for FitScore reports
 *
 ...
 *         Diff vs v1.0.2: Standard branch drops "composite {score}" numeric from the opening
 *         sentence. Band label stands alone; numeric no longer anchors the sentence.
 *         All dimension comparisons are null-safe (supports number | null dimension scores).
 *         Spec: ADDENDUM_14H_DENSITY_SURFACE_PASS §16 (D-DSP-35).
 */
...
export const SYNTHESIS_TEMPLATE_VERSION = 'synthesis.v1.0.3'
