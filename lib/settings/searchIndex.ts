...
const SETTINGS_INDEX: SettingsDest[] = [
  ...
  { label: "Two-factor", subtitle: "Security", section: "account", href: "/settings/security?tab=password", kw: "2fa otp totp authenticator mfa" },
  { label: "Passkeys", subtitle: "Security", section: "account", href: "/settings/security?tab=password", kw: "passkey face id touch id biometric" },
  ...
  { label: "Availability", subtitle: "Organisation", section: "workspace", href: "/settings/details?tab=hours", kw: "office hours open close weekday after-hours emergency phone contact availability" },
  ...
  { label: "Templates", subtitle: "Workspace", section: "workspace", href: "/settings/templates", kw: "documents letters emails whatsapp notices arrears" },
  { label: "Document templates", subtitle: "Templates", section: "workspace", href: "/settings/templates", kw: "letter email whatsapp arrears notice correspondence flavours tone" },
  { label: "Lease templates", subtitle: "Templates", section: "workspace", href: "/settings/templates?tab=leases", kw: "lease clauses agreement" },
