...
function CoverPage({ d, periodLabel, displayName }: Readonly<{ d: TrustAuditData; periodLabel: string; displayName: string }>) {
  return (
    <Page size="A4" style={S.page}>
      ...
      <MetaRow label="Generated at" value={new Date(d.generatedAt).toLocaleString("en-ZA", { timeZone: SA_TIMEZONE })} />
      ...
      <View style={S.legend}>
        ...
        <Text>
          ...
          the agency{"'"}s own Section 54 trust account. Pleks does not hold, custody, or
...
function AttestationPage({ d, periodLabel, displayName, pageNum }: Readonly<{
  ...
  return (
    <Page size="A4" style={S.page}>
      ...
      <MetaRow label="Signed off by" value={sp(d.signedOffByEmail)} />
      <MetaRow label="Date and time" value={new Date(d.signedOffAt).toLocaleString("en-ZA", { timeZone: SA_TIMEZONE })} />
      <MetaRow label="IP address" value={sp(d.signedOffIp) || "—"} />
      ...
      <View style={S.legend}>
        ...
        <Text>Generated by Pleks on {new Date(d.generatedAt).toLocaleString("en-ZA", { timeZone: SA_TIMEZONE })}</Text>
        ...
        <Text style={{ marginTop: 6 }}>
          ...
          Section 54 trust account. Pleks does not hold, custody, or control any client funds.
        </Text>
      </View>
