...
BEGIN
  ...
  INSERT INTO payments (id, org_id, lease_id, tenant_id, invoice_id, amount_cents, payment_date, payment_method, reference) VALUES
    ...
    ('a4000001-0000-0000-0000-000000000102', v_org_id, 'e0000001-0000-0000-0000-000000000002', 'd0000001-0000-0000-0000-000000000002', 'f0000001-0000-0000-0000-000000000102', 850000, '2026-01-01', 'bank_recon_matched', 'DC-VDB-JAN'),
    ...
    ('a4000001-0000-0000-0000-000000000104', v_org_id, 'e0000001-0000-0000-0000-000000000004', 'd0000001-0000-0000-0000-000000000004', 'f0000001-0000-0000-0000-000000000104', 1800000, '2026-01-01', 'bank_recon_matched', 'DC-MOKOENA-JAN'),
    ...
    ('a4000001-0000-0000-0000-000000000202', v_org_id, 'e0000001-0000-0000-0000-000000000002', 'd0000001-0000-0000-0000-000000000002', 'f0000001-0000-0000-0000-000000000202', 850000, '2026-02-01', 'bank_recon_matched', 'DC-VDB-FEB'),
    ('a4000001-0000-0000-0000-000000000204', v_org_id, 'e0000001-0000-0000-0000-000000000004', 'd0000001-0000-0000-0000-000000000004', 'f0000001-0000-0000-0000-000000000204', 1800000, '2026-02-01', 'bank_recon_matched', 'DC-MOKOENA-FEB'),
    ...
    ('a4000001-0000-0000-0000-000000000302', v_org_id, 'e0000001-0000-0000-0000-000000000002', 'd0000001-0000-0000-0000-000000000002', 'f0000001-0000-0000-0000-000000000302', 850000, '2026-03-01', 'bank_recon_matched', 'DC-VDB-MAR'),
    ('a4000001-0000-0000-0000-000000000304', v_org_id, 'e0000001-0000-0000-0000-000000000004', 'd0000001-0000-0000-0000-000000000004', 'f0000001-0000-0000-0000-000000000304', 1800000, '2026-03-01', 'bank_recon_matched', 'DC-MOKOENA-MAR'),
    ...
    ('a4000001-0000-0000-0000-000000000404', v_org_id, 'e0000001-0000-0000-0000-000000000004', 'd0000001-0000-0000-0000-000000000004', 'f0000001-0000-0000-0000-000000000404', 1800000, '2026-04-01', 'bank_recon_matched', 'DC-MOKOENA-APR')
  ON CONFLICT (id) DO NOTHING;
