...
CREATE INDEX IF NOT EXISTS idx_property_photos_unit_id     ON property_photos(unit_id);
...
CREATE INDEX IF NOT EXISTS idx_inspection_items_room       ON inspection_items(room_id);

-- Inspection photos
CREATE INDEX IF NOT EXISTS idx_inspection_photos_inspection ON inspection_photos(inspection_id);
CREATE INDEX IF NOT EXISTS idx_inspection_photos_item       ON inspection_photos(item_id);
...
DROP POLICY IF EXISTS "org_properties" ON properties;
...
DROP POLICY IF EXISTS "org_units" ON units;
...
DROP POLICY IF EXISTS "org_unit_status_history_select" ON unit_status_history;
...
DROP POLICY IF EXISTS "org_property_documents" ON property_documents;
...
DROP POLICY IF EXISTS "org_property_photos" ON property_photos;
...
DROP POLICY IF EXISTS "org_inspections" ON inspections;
...
DROP POLICY IF EXISTS "org_inspection_rooms" ON inspection_rooms;
...
DROP POLICY IF EXISTS "org_inspection_items" ON inspection_items;
...
DROP POLICY IF EXISTS "org_inspection_photos_insert" ON inspection_photos;
