...
--     MOVED to 002_contacts.sql (right after the tenants table) so the 005 §28.4
--     "Applicants can read their own bureau PDFs" storage policy — which references
--     tenants.auth_user_id — resolves on clean from-scratch replay. Kept here as a
...
-- Index moved here from 002 — first_attempt_log_id is added just above. (migration-replay fix, 2026-07-06)
