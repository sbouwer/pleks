...
-- Legal review: v3 final 2026-04-02 — APPROVED with amendments.
-- Amendments applied: (1) pets fumigation-upon-exit, (2) battery discharge guidance.
-- Annexure D consistency check: no "Addendum D" or "Schedule D" found in existing body_templates.
